...
Route::group(['prefix' => 'admin', 'middleware' => 'admin', 'as' => 'admin.'], function () {
    ...
    #ManagerTask routes
    Route::get('manager-task', 'Admin\ManagerTaskController@managerWeeklyTask')->name('manager-task');

    #FrontDeskDaily routes
    Route::get('front-desk-daily-task', 'Admin\FrontDeskDailyController@viewFrontDesk')->name('front-desk-daily-task');
