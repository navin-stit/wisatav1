<ul id="menu" class="page-sidebar-menu">
    ...
    <li>
        <a href="{{   route('admin.logbook') }}">
            <i class="livicon" data-name="bookmark" data-size="18" data-c="#EF6F6C" data-hc="#EF6F6C"
               data-loop="true"></i>
            Logbook
        </a>
    </li>
    ...
    <li>
        <a href="{{ Url::to('admin/manager-task') }}">
    ...
    <li>
        <a href="{{ route('admin.front-desk-daily-task') }}">
            <i class="livicon" data-name="desk" data-size="18" data-c="#F89A14" data-hc="#F89A14"
               data-loop="true"></i>
            Front Desk
        </a>
    </li>
    ...
    <li>
        <a href="">
            <i class="livicon" data-name="bell" data-size="18" data-c="#EF6F6C" data-hc="#EF6F6C"
               data-loop="true"></i>
            Room Checks
        </a>
    </li>
    ...
    <li>
        <a href="">
            <i class="livicon" data-name="phone" data-size="18" data-c="#EF6F6C" data-hc="#EF6F6C"
               data-loop="true"></i>
            Ordering
        </a>
    </li>
