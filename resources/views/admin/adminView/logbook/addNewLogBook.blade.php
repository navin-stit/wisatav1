                ...
                <div class="card todolist">
                    ...
                    <div class="card-body nopadmar">
                        ...
                        <div class="add_list adds">
                            {!! Form::open(['class'=>'form', 'id'=>'main_input_box', 'method' => 'post',  ]) !!}
                            <div class="form-group">
                                {!! Form::label('Logbook_description', 'Logbook description : ') !!}
                                
                                {!! Form::text('Logbook_description', null, ['class' => 'form-control','id'=>'task_description', 'required' => 'required', 'name' => 'notes']) !!}
                            </div>
                            <div class="form-group">
